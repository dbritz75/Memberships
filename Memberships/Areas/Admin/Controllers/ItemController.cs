...
namespace Memberships.Areas.Admin.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        {
            //Because we need to fill in a dropdown list
            var model = new Item
            {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,Title,Description,ItemURL,ImageURL,HTML,WaitDays,ItemTypeID,ProductID,SectionID,PartID,IsFree")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,Title,Description,ItemURL,ImageURL,HTML,WaitDays,ItemTypeID,ProductID,SectionID,PartID,IsFree")] Item item)
        {
            if (ModelState.IsValid)
            {
