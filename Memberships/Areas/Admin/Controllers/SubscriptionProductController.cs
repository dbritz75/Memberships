...
namespace Memberships.Areas.Admin.Controllers
{
    ...
    public class SubscriptionProductController : Controller
    {
        ...
        {
            return View(await db.Subscriptions_Products.Convert(db));
        }
        ...
        private async Task<Subscription_Product> GetSubscriptionProduct(
        int? subscriptionId, int? productId)
        {
            try
            {
                ...
                var subscriptionProduct = await db.Subscriptions_Products.FirstOrDefaultAsync(
