...
namespace Memberships.Areas.Admin.Controllers
{
    ...
    public class SubscriptionController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,Title,RegistrationCode,Description")] Subscription subscription)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,Title,RegistrationCode,Description")] Subscription subscription)
        {
            if (ModelState.IsValid)
            {
